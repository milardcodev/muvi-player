...
import com.muviplayer.android.databinding.ActivityPlaylistBinding
import com.muviplayer.android.databinding.AddPlaylistDialogBinding
...
class PlaylistActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(musicPlaylist.ref.isNotEmpty())
